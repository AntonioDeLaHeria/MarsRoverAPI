...
//Creating an object that has the properties of the API... that we're representing in our model

// Create one generic object to pass data back and forth from... front-end | MVC | Server-Side
